        ...
        setCourses(
          enrollments.map((e) => {
            ...
            return {
              id: e.subject_id,
              code: s?.subject_code || '',
              title: s?.subject_title || 'Unknown subject',
        ...
        <div className="relative bg-gradient-to-r from-primary-700 to-primary-900 px-5 sm:px-8 pt-6 pb-5">
          ...
          <div className="mt-3">
            <div className="flex justify-between text-[11px] text-primary-100/90 mb-1.5">
              <span className="font-medium">{isTeacher ? 'Content readiness' : 'Overall subject progress'}</span>
          ...
          <aside className="min-w-0">
            <div className="ws-card overflow-hidden">
              <div className="ws-card-header">
                <h2 className="ws-section-title">{isTeacher ? 'Subjects you teach' : 'Enrolled subjects'}</h2>
                {courses.length > 0 && (
                  <button
                    onClick={() => navigate('/materials')}
              ...
              {loading ? (
                ...
                <p className="px-4 py-6 text-center text-[12.5px] text-slate-400">
                  {isTeacher ? 'You are not assigned to any subjects yet.' : 'You are not enrolled in any subjects yet.'}
                </p>
              ) : (
