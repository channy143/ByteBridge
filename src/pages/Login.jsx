...
export default function Login() {
  ...
  const handleStudentSubmit = async (e) => {
    ...
    try {
      ...
      // No manual navigation here: the login page auto-redirects to `from`
      // once the auth session AND the profile are loaded, which prevents
      // the white-screen/login-page flash during the transition.
    } catch (err) {
