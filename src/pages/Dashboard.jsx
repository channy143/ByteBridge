  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle={isTeacher ? "Here's what's happening with your subjects." : "Here's what's happening with your BTLED ICT subjects."}
        actions={
          ...
          <div className="ws-card flex-1">
            <div className="ws-card-header">
              ...
              <button onClick={() => navigate('/materials')} className="flex items-center gap-1 text-[12.5px] font-medium text-primary-600 hover:text-primary-700">
                Open subjects <ArrowRight className="w-3.5 h-3.5" />
              </button>
            </div>
            {loading ? (
              ...
              <EmptyState
                ...
                title={isTeacher ? 'No subjects published yet' : 'You\'re not enrolled in any subjects yet'}
                description={isTeacher ? 'Subjects will appear here once published.' : 'Ask your instructor or administrator to add you to a subject.'}
              />
            ) : (
